...
export default function Users(props) {
    ...
    actions: [
      ...
      },
      {
        ...
        onClick: (event, rowdata) => {
          ...
          console.log("onclick table", table);
          console.log("onclick group", group);
          console.log("onclick event", event);
          console.log("onclick rowdata", rowdata);
          //deleteUser(rowdata);
        }
      }
    ],
  ...
  const refreshTable = () => {
    console.log(`props.group on refreshTable`, props.group);
    if (props.group == 0) {
      setTable({ ...table, data: [] });
    } else {
      axios
  ...
  useEffect(() => {
    console.warn(`useEffect`, props.open, props.group);
    refreshTable();
